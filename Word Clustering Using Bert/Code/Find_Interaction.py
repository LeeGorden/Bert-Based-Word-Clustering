...
centrality_e, graph_info_e, nodes_pos_dict_e = Calculate_Centrality.draw_topology_graph(X_train, interaction_nodes_e,
                                                                                        layout='spring', feature=False, label=False)